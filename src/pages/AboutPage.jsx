...
const AboutPage = () => {
  return (
   ...
   <Header/>
      ...
      <Container>
        <h1 className="mb-4 text-center animate__animated animate__fadeInDown">About ORS Project</h1>
        <p className="lead animate__animated animate__fadeInUp">
          The Internet Based Testing (IBT) System is a web-based application developed to streamline and digitize the examination process for universities and academic institutions. It automates the entire examination lifecycle — from student registration, question management, exam conduction, to report generation.
        </p>
        ...
        <p>
          The IBT system has great potential for future enhancements, such as adaptive testing, AI-based evaluation, multimedia integration, LMS integration, advanced analytics, and real-time monitoring for remote proctoring.
        </p>
      </Container>
    </div>
    <Footer/>
