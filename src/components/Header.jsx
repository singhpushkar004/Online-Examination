  ...
  return (
    <div className="ibt-header-wrapper position-sticky sticky-top">
      ...
      <Navbar expand="lg" variant="dark" className="ibt-navbar">
        <Container>
          <Navbar.Brand className="fw-bold">Online Result System</Navbar.Brand>
          ...
          <Navbar.Collapse id="ibt-navbar-nav">
            <Nav className="ms-auto">
              ...
              <Nav.Item>
                <Link to="/login">
                  <Button variant="outline-light" className="ms-2  border-0" style={{marginTop:"30px"}}>Login</Button>
                </Link>
              </Nav.Item>
            </Nav>
          </Navbar.Collapse>
